...
def retrieve_knowledge(query, knowledge_base_dir, max_results=5):
    """
    从知识库中检索相关信息
...
def search_by_tags(tags, knowledge_base_dir, max_results=10):
    """
    根据标签搜索知识
...
def search_by_category(category, knowledge_base_dir, max_results=10):
    """
    根据分类搜索知识
